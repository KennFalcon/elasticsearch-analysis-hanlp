...
方式二
   ...
   `./bin/elasticsearch-plugin install https://github.com/KennFalcon/elasticsearch-analysis-hanlp/releases/download/v6.3.3/elasticsearch-analysis-hanlp-6.3.3.zip`
